...
My approach of this project is study the historical housing prices in Ames and housing dataset features provided by Ames, Iowa Assessor's Office.

### Stakeholder
My stakeholders of this reserach is the Ames Housing Authority, local banks and local property agenct/agencies.


My potential buyers could be ranging from the buyers wanting to upgrade or downgrade the house, 1st time buyer(s), new-wedded couple or new movers to Ames.

My estimation of the housing price is for the short term target, like 3-5 years because the house price will fluctuation is unexpected year to year it is advicable to revisit the data every year to get the latest prediction of the housing price.

I will using the Ames housing data to create regression models that predicts the price of houses in Ames, Iowa. The housing is recorded between 1872 and 2010.
...
The owner of the house can do a number of remodelling improvement to increase the value of the house but these would need to be cost justified. Exmaple include expansion of the masonry veneer area, increasing size of garage, changing garage style or house style.
...
The model is constructed based of the Ames, Iowa dataset. The basic predicbility of the model is still applicable but it has to be customized based on the other cities features which invovle changes.
